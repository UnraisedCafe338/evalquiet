...
include('../connection.php');
          if ($connection) {
            $query = "SELECT * FROM student_info ORDER BY student_lastName" ;
            $result = mysqli_query($connection, $query);
...
<script>
 ...
 function searchTable() {
  ...
  var url = 'student_print.php?search=' + encodeURIComponent(searchInput) + 
            '&course=' + encodeURIComponent(courseFilter) + 
